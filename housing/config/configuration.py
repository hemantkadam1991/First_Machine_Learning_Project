...
from housing.entity.config_entity import DataIngestionConfig, DataValidationConfig, DataTransformtionConfig, \
...
class Configuration:
    ...
    def get_data_transformation_config(self) -> DataTransformtionConfig:
        try:
            artifact_dir = self.training_pipeline_config.artifact_dir

            data_trasformation_artifact_dir =os.path.join(
                artifact_dir,
