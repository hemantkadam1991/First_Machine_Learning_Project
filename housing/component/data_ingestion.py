...
class DataIngestion:
    ...
    def download_housing_data(self,) -> str:
        try:
            ...
            #getting folder location to download file
    ...
    def split_data_as_train_test(self) -> DataIngestionArtifact:
        try:
            ...
            data_ingesion_artifact = DataIngestionArtifact(train_file_path=train_file_path,
                                test_file_path=test_file_path,
                                is_ingested=True,
                                message = f"Data ingestion completed successfully"
                                )
            logging.info(f"Data Ingestion artifact: [{data_ingesion_artifact}]")
            return data_ingesion_artifact
